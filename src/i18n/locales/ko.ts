...
export default {
  ...
  "setting.sync.auto_config_desc": "활성화하면 <b>${configDir}</b> 디렉토리의 핵심 설정, 플러그인, 외관, 테마 등의 설정을 동기화합니다. 처음 활성화할 경우 서버 설정이 로컬 설정을 덮어씁니다.",
