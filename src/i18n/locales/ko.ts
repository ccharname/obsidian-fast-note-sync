...
export default {
  ...
  "setting.general.share_manage_desc": "모든 공유를 한곳에서 확인, 수정, 취소할 수 있습니다.",
  ...
  "ui.share.expire.label": "만료 기간",
  "ui.share.expire.current": "현재 만료 시간",
  "ui.share.expire.keep": "변경하지 않음",
  "ui.share.expire.never": "영구",
  "ui.share.expire.1d": "1일",
  "ui.share.expire.7d": "7일",
  "ui.share.expire.30d": "30일",
  "ui.share.expire.confirmTitle": "만료 시간 변경",
  "ui.share.expire.confirmClearPassword": "만료 시간을 변경하면 현재 접속 비밀번호도 함께 지워집니다(서버 특성상 유지하려면 비밀번호를 다시 입력해야 합니다). 계속하시겠습니까?",
  "ui.share_manage.title": "공유 관리",
  "ui.share_manage.empty": "아직 공유가 없습니다",
  "ui.share_manage.status_active": "활성",
  "ui.share_manage.status_cancelled": "취소됨",
  "ui.share_manage.has_password": "비밀번호 보호됨",
  ...
  "ui.offline_guard.title": "기기가 오랫동안 오프라인 상태였습니다",
  "ui.offline_guard.message": "이 기기가 오랫동안 오프라인 상태였습니다. 이번 동기화에서 약 ${count}개의 \"로컬에만 있고 서버에는 없는\" 파일이 업로드되려고 합니다. 다른 기기에서 이미 삭제되었지만 서버의 삭제 기록이 만료된 파일일 수 있습니다(잘못 복원될 위험이 있음). 계속 업로드하시겠습니까?",
  "ui.offline_guard.confirm": "계속 업로드",
};
