...
export default {
  ...
  "setting.general.share_manage_desc": "在同一處集中檢視、修改或取消你的所有分享。",
  ...
  "ui.share.expire.confirmClearPassword": "修改有效期會同時清空目前的存取密碼（伺服器限制，如需保留密碼請一併重新輸入），是否繼續？",
  "ui.share_manage.title": "分享管理",
  "ui.share_manage.empty": "尚無分享",
  ...
  "ui.share_manage.cancel_confirm": "確認取消此分享？此操作無法復原。",
