...
export default {
  ...
  "setting.general.share_manage": "Manage Shares",
  "setting.general.share_manage_button": "Open Share Management",
  "setting.general.share_manage_desc": "View, edit, or cancel all your shares in one place.",
  ...
  "ui.share.expire.never": "Never expires",
  "ui.share.expire.1d": "1 day",
  "ui.share.expire.7d": "7 days",
  "ui.share.expire.30d": "30 days",
  "ui.share.expire.confirmTitle": "Change Expiration",
  "ui.share.expire.confirmClearPassword": "Changing the expiration will also clear the current access password (the server requires resending the password to keep it). Continue?",
  "ui.share_manage.title": "Manage Shares",
  "ui.share_manage.empty": "No shares yet",
